        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border-2 border-green-100 dark:border-green-700">
          ...
          <form onSubmit={handleLogin} className="px-6 py-8" autoComplete="off">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <Link to="/forgot-password" className="text-sm text-green-600 hover:text-green-700 dark:hover:text-green-400 font-semibold transition-colors hover:underline">
                Forgot password?
              </Link>
            </div>
